...
import CategorizeFlashCard from './CategorizeFlashCard';
...
class CategorizeFlashCardContainer extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        cards: [],
  ...
  export default CategorizeFlashCardContainer;